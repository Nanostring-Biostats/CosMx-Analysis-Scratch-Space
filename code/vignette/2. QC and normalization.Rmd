...
falsecounts <- readRDS(paste0(mydir, "/processed_data/falsecounts.RDS")) 
...
Here we see two major drivers of spatial signal. First, small round glomeruli (these samples are kidneys)
