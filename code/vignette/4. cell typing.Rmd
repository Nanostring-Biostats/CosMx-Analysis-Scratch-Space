...
Automated cell typing algorithms sometimes work out of the box, but often enough they do not. 
...
Since nothing obviously suspicious emerges from casual examination of the above results, so we'll make arbitrary updates. 
...
res2 <- refineClusters(logliks = res$logliks, 
                       ...
                       to_delete = "NKT.cell",                    # delete this cluster and send its cells to their next-best fit
                       subcluster = list("Proximal.tubule" = 3))  # subcluster proximal tubules into 3 new clusters
...
saveRDS(res2$clust, file = paste0(mydir, "/processed_data/clust.RDS"))
```