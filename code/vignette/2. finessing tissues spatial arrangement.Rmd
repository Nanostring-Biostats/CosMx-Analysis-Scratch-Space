...
We'll perform two basic tasks in this opening script: 

1. Load in and format the flat files export by AtoMx
2. (Optional) Rearrange FOV's xy positions by hand for plots with less white space

## Loading and formatting flat files from AtoMx
...
```{r libraries}
library(data.table) # for more memory efficent data frames
