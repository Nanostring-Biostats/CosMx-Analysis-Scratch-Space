...
# NEED TO IMPLEMENT AN ACTUAL FILTER HERE
...
factors acting on Mesangial cell gene expression, but we should try our best to capture
the major factors. 

So instead, we might try the following model:

*E(y) = f(number of nearby macrophages, number of nearby glomerular endothelium cells, number of nearby lymphoid compartment cells, spatial cluster)*.

This model accounts for other immune impacts on mesangial cell expression and for any impact
