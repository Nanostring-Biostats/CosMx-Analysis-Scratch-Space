...
For a more detailed discussion, as well as examples of syntax for calling these models, we point the reader to the [spatial-vignette](https://github.com/Nanostring-Biostats/smiDE/blob/main/vignettes) and the help page (`?smiDE::spatial_model`).
