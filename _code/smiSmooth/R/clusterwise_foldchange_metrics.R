...
#' @param cluster_column column in metadata corresponding to 
#' @param totalcounts optional user-specified vector of totalcounts used for normalizing the counts matrix.  (useful if a subsetted counts matrix is passed)
#' 
#' @export
