...
First, we load in only the data we need, which was output by the earlier script from the [workflow vignette](https://github.com/Nanostring-Biostats/CosMx-Analysis-Scratch-Space/tree/vignette-melanoma/_code/vignette):
...
#source("https://raw.githubusercontent.com/Nanostring-Biostats/CosMx-Analysis-Scratch-Space/vignette-melanoma/_code/vignette/utils/condenseTissues.R")
set.seed(1)
