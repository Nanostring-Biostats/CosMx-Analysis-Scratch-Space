...
source("https://raw.githubusercontent.com/Nanostring-Biostats/CosMx-Analysis-Scratch-Space/fov_qc_quarto/_code/FOV%20QC/FOV%20QC%20utils.R")
# load necessary information for the QC tool: the gene to barcode map:
allbarcodes <- readRDS(url("https://github.com/Nanostring-Biostats/CosMx-Analysis-Scratch-Space/raw/fov_qc_quarto/_code/FOV%20QC/barcodes_by_panel.RDS"))
names(allbarcodes)
...
We didn't flag any FOVs for signal loss, but it's still worth examining:
