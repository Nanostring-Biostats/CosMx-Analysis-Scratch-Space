...
- [X] [File structure outputs by the AtoMx export module](posts/segmentation-error-evaluation/assets/Pancreas-CosMx-ReadMe.html), example dataset used could be downloaded from [here](https://nanostring.com/products/cosmx-spatial-molecular-imager/ffpe-dataset/cosmx-smi-human-pancreas-ffpe-dataset/){target="_blank"}.
...
- [ ] Converting between data formats: AtoMx flat files and squidpy
