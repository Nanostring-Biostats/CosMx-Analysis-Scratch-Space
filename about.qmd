...
of CosMx<sup>&#174;</sup> Spatial Molecular Imager (SMI) data. Contained here are writeups
...
- [X] [File structures for outputs of the AtoMx<sup>&#174;</sup> export module](/assets/Pancreas-CosMx-ReadMe.html){target="_blank"}
- [X] [Creating an `anndata` object from AtoMx<sup>&#174;</sup> exported results for interactive viewer and python-based analysis](posts/h5ad_conversion/index.qmd)
- [X] [Making composite images from layered morphology 2D images](posts/composite-images/making-composite-images.qmd)
- [X] [Comparing AtoMx<sup>&#174;</sup> SIP flat files with the legacy format](posts/flat-file-exports/flat-files-compare.qmd)
- [X] [Tool for aligning protein and RNA data](posts/multiomics-alignment/index.qmd)
- [X] [Generating an expression matrix from aligned RNA data](posts/aligned_rna_exp_matrix/index.qmd)
...
- [X] [Impacts of background in CosMx<sup>&#174;</sup> data](posts/background/index.qmd)
- [X] [Batch correction](posts/batchcorrection/index.qmd)
...
- [X] [Cellular neighborhoods: a useful, simple and flexible analysis framework](posts/cellular-neighborhoods/cellular-neighborhoods.qmd)
- [X] [InSituDiff: Perturbation analysis of disease vs. control cellular neighborhoods](posts/insitudiff/index.qmd)
- [X] [InSituCor: Discovering modules of spatially correlated genes](posts/insitucor/index.qmd)
- [X] [Guide to comparing data from different CosMx panels](posts/panel-comparison/index.qmd)
- [X] [Tips for using the AtoMx Spatial Discovery workflow](posts/spatial-discovery-tips/index.qmd)

## Cell typing

- [X] [Cell typing: what we've found to work](posts/cell-typing-basics/index.qmd)
- [X] [Cell typing: advanced strategies](posts/cell-typing-strategies/cell-typing-strategies.qmd)
- [X] [Creating reference profiles](/posts/hybrid-reference-profiles/index.qmd)
- [X] [On the use of marker genes](posts/on-cell-typing-with-marker-genes/index.qmd)
- [X] [Hierarchical tree-style cell typing](posts/tree-cell-typing/index.qmd)
- [X] [Smoothed marker genes for cell typing and visualization](posts/marker-gene-smoothing/index.qmd)
- [X] [Using marker gene driven metagene scores for granular hierarchical cell typing](posts/immune-cell-typing-smooth/index.qmd)
- [ ] Integrating spatial information and/or cell images into existing cell typing results
- [X] [CosMx SMI Cell Profiles](posts/cosmx-cell-profiles/index.qmd)
- [X] [Integrated RNA + protein multiomic cell typing using HieraType](posts/multiomics-hieratype/index.qmd)
- [X] [HierAnnot: A Hierarchical Auto-Annotation Step for Modern Spatial Analysis](posts/auto-cluster-naming/index.qmd)
- [X] [Multi-state Annotation with HierAnnot: Tumor Status and Auxiliary Program Tracks](posts/multi-state-annot/index.qmd)

## Cell segmentation

- [X] [The impact of segmentation error on differential expression analyses](posts/segmentation-error/index.qmd)
- [X] [FastReseg: Evaluating cell segmentation error based on transcripional spatial profiles](posts/segmentation-error-evaluation/index.qmd)
- [X] [Guide to run transcript-based segmentation and refinement on CosMx data](posts/transcript-segmentation/index.qmd)
- [X] [Advancing cell segmentation in spatial omics: new models for diverse morphologies](posts/image-segmentation-models/index.qmd)

## Data visualization

- [X] [Plotting spatial data](posts/spatial-plotting/index.qmd)
- [X] [Visualizing spatial data with Seurat](posts/seurat-cosmx-basics/index.qmd)
- [X] [NeighVizGallery: Visualization of cellular neighborhood in gallery mode](posts/visualize-cellular-neighborhood-in-gallery-mode/index.qmd)
- [X] [Functions for condensing FOVs and tissues to minimize whitespace](posts/visuals-reduce-whitespace/index.qmd)
- [X] [cellPoly: Inferring cell polygons from transcript locations](posts/deriving-cell-polygons-from-transcript-locations/index.qmd)
...
- [X] [Programmatic stitching of CosMx SMI protein with `napari-cosmx`](posts/napari-protein-stitching/napari-cosmx-protein-stitching.qmd)
- [X] [Exporting Zarr Stores to OME-TIFF](posts/napari-ome-tiff/cosmx-ome-tiff.qmd)
- [X] [Advanced plugin tips: creating regions of interests to select cells](posts/napari-rois/cosmx-rois.qmd)
- [ ] Advanced plugin tips: reproducibility of images and creating animations
- [X] [Aligning H&E and CosMx Images in napari](posts/napari-alignment-tools/index.qmd)
- [X] [Unlocking Spatial Insights: Multi-Omics & 3D RNA Analysis with `napari-CosMx`](posts/napari-3d-multiomics/index.qmd)
...
- [X] [GeoMx&#174; DSP analysis vignette for high-plex protein data](posts/geomx_vignette/index.qmd)
