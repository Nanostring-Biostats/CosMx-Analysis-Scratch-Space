...
- [X] [File structures for outputs of the AtoMx&#8482; export module](posts/segmentation-error-evaluation/assets/Pancreas-CosMx-ReadMe.html). <br/>
        - The example dataset used could be downloaded from [here](https://nanostring.com/products/cosmx-spatial-molecular-imager/ffpe-dataset/cosmx-smi-human-pancreas-ffpe-dataset/){target="_blank"}. <br/>
        - The exact file structures might have minor difference from the example shown here depending on the version of AtoMx&#8482; software. 
- [X] [Creating `anndata` object from AtoMx&#8482; exported results for interactive viewer and python-based analysis](posts/h5ad_conversion/index.qmd)
...
## Viewing CosMx data with Napari

- [X] [Intro: using Napari to view and analyze CosMx data and creating napari-ready files from AtoMx exports](posts/using-napari-for-cosmx-data/index.qmd)
