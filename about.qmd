...
- [X] [Smoothing single cell gene expression for enhanced plotting](posts/marker-gene-smoothing/index.qmd)
...
- [X] [Perturbation analysis of disease vs. control cellular neighborhoods](posts/insitudiff/index.qmd)
- [X] [Discovering modules of spatially correlated genes](posts/insitucor/index.qmd)
...
- [X] [Cell typing with smoothed marker genes](posts/marker-gene-smoothing/index.qmd)
