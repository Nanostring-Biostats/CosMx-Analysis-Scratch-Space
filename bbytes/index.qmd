...
::: {.tool-card}
::: {.thumbnail-container}
![](./pub_tracker/thumbnail.png)
:::
### Publication Pulse
**Publication tracker**

Your daily dashboard for publications using BSB platforms.

[Launch Tracker →](pub_tracker/index.html){.btn .btn-primary}
:::

::: {.tool-card}
::: {.thumbnail-container}
<video src="./proj_animation/projection_animation.mp4" loop muted autoplay controls width="100%"></video>

:::
### Projection Animator
**Animate between expression and spatial projections**

Animate your data between expression space and physical space right from your
browser.

[Launch Animator →](proj_animation/index.html){.btn .btn-primary}
:::
