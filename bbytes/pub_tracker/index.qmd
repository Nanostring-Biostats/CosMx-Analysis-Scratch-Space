...
<p class="max-w-xl text-lg md:text-xl text-slate-600 font-light leading-relaxed mb-10 border-l-4 border-primary pl-6">
  Visualize the cumulative publication growth across select Bruker Spatial Biology platforms. 
</p>
...
```{=html}
  ...
  <div class="relative z-10 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 mt-2 border-t border-slate-200/60 pt-6">
    <div class="text-amber-700 text-sm font-bold bg-amber-50/80 backdrop-blur-sm px-4 py-2.5 rounded-xl border border-amber-200 shadow-sm leading-snug max-w-2xl">
      ...
      Note: This is a sample query, not an exhaustive list. It was generated automatically by searching specific terms like "CellScape", "CosMx", "AtoMx", "GeoMx", and "nCounter" that were found in the title, abstract, and full text (if applicable). It may miss publications using broader terminology or publications not found on openAlex.
    </div>
...
<div class="container mx-auto px-6">
  <div class="mb-8">
    <h2 class="text-4xl font-bold text-slate-900 tracking-tight font-serif">Research Landscape</h2>
    <p class="text-slate-500 text-lg mt-2">
      Explore the taxonomic hierarchy of the selected platforms. 
      <strong class="text-slate-700">Click a Blue Field</strong> to burst it into its specific Topics. 
