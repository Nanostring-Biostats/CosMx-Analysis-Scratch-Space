...
<div class="absolute top-6 right-8 z-50">
  <a href="https://nanostring-biostats.github.io/CosMx-Analysis-Scratch-Space/bbytes/" class="flex items-center gap-2 px-4 py-2 bg-surface-light border border-gray-200 rounded-full shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 text-text-sub hover:text-primary font-display font-medium text-sm">
