...
This is further shown below in the middle-and-right panels when looking at CD3D and CD2 RNA markers.  <span style="color:#E41A1C;">Multiomic</span> celltyping outperforms protein-only by the widest margin, and also slightly outperforms <span style="color:#377EB8;">RNA-only</span>.
...
#fwrite(multictobj$post_probs[[1]][1:10], file="figures/postprobs_head.csv")
print(data.table::fread("figures/postprobs_head.csv")[])
```
```{r}
#| eval: false
#| echo: true
