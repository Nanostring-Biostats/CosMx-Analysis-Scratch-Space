...
Also see the companion posts on [exploratory data analysis](https://nanostring-biostats.github.io/CosMx-Analysis-Scratch-Space/posts/vignette-basic-analysis-updated/02_exploratory_analysis.html) and confirmatory analysis with [differential expression testing](https://nanostring-biostats.github.io/CosMx-Analysis-Scratch-Space/posts/vignette-basic-analysis-updated/03_DE.html). 
...
| [Graph clustering (Louvain or Leiden)](#clust) | Nearest neighbors | Clusters |
| [InSituType clustering](#clust) | Raw counts, HVGs, metadata (mean negprobe column) | Clusters |
...
source("https://raw.githubusercontent.com/Nanostring-Biostats/CosMx-Analysis-Scratch-Space/Main/_code/vignette2/readFlatFiles.R")
...
hist(metadata$Area, breaks = 100, main = "", xlab = "Cell area (pixels)")
