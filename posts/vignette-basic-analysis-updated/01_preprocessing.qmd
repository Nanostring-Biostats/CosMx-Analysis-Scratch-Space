...
| [Dimension reduction](#dimred): PCA | xy, metadata, HVGs | PCs |
...
| [InSituType clustering](#insitutype) | Raw counts, HVGs | Clusters |
...
When your data is too large to fit into memory -- and this can happen with just a few slides of WTX data --
 you need  modify the above strategy. 
...
Note: some tissues do have very large cells, e.g. purkinje cells in the brain or cardiomyocytes in the heart. You'll want to skip the area filter in those studies. 
...
it's cheaper to re-compute it that to store it. 
