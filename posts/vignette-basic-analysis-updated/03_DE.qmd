...
Below we recommend different approaches for different settings:
...
## run fast DE:
fastres <- hastyDE(y = norm, df = data.frame(distance2tumor = x))
...
## run fast DE:
fastres <- hastyDE(y = norm[, genes_to_analyze], df = data.frame(distance2tumor = x))
