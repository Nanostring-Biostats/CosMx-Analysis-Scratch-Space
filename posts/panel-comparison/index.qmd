...
To demonstrate this approach, we'll look at data from a colorectal tumor profiled with the CosMx Human 6k Discovery Panel and the CosMx Human Whole Transcriptome Panel.
...
#| eval: true
#| echo: false
knitr::include_graphics("./figures/marker_heatmap_sixk.png")
knitr::include_graphics("./figures/marker_heatmap_wtx.png")
```
