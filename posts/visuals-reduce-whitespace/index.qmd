...
As a partial solution, see the function consenseXY(), provided [here](https://github.com/Nanostring-Biostats/scratch-space/blob/main/_code/condensing%20xy%20space/CondenseXY.R){target="_blank"}.
