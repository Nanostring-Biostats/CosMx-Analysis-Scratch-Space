...
affiliations:
  - id: nstg
    ...
    state: WA
  - id: crwilliams11
    name: "Github: [@crwilliams11](https://github.com/crwilliams11)"
toc: true
toc-title: Contents
toc-depth: 3
toc-expand: 2
...
This is a non-comprehensive vignette to introduce the use of the Seurat package to visualize and work with data generated from the CosMx&#8482; Spatial Molecular Imager (SMI). This vignette does not cover analysis of data in Seurat but rather tries to address frequently asked questions we've received from customers on getting started with their data in Seurat. As additional resources, please see vignettes on the Seurat website: [Spatial Vignette](https://satijalab.org/seurat/articles/seurat5_spatial_vignette_2.html#human-lung-nanostring-cosmx-spatial-molecular-imager) and
[Clustering Tutorial](https://satijalab.org/seurat/articles/pbmc3k_tutorial). Also see additional blog posts on our [scratch space](https://nanostring-biostats.github.io/CosMx-Analysis-Scratch-Space/about.html).

For this vignette, we use a Seurat object made from the mouse brain public data set and assembled in the structure used by the Technology Access Program [TAP](https://nanostring.com/products/cosmx-spatial-molecular-imager/technology-access-program/); similar outputs are available from the AtoMx&#8482; Spatial Informatics Portal (SIP). To download raw data for this dataset, go [here](https://nanostring.com/products/cosmx-spatial-molecular-imager/ffpe-dataset/cosmx-smi-mouse-brain-ffpe-dataset/). 
...
Load in the Seurat object, available on Box.com [here](https://nanostring.box.com/s/y7ielc54qw1g1f5x98hxczdo8tezobbg).
...
# Transcript counts. Here, transcripts counts are in the 'Nanostring' assay but in other objects they may be stored in an 'RNA' assay.
