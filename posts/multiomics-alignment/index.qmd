...
Download and unzip the `MultiO_Alignment_Tool_OCT2025.zip` file available [here](https://bruker-my.sharepoint.com/:u:/p/s_korukonda/IQDEqiT2UmovRqi2xgteIkwrAbz2jIXuVVaOzDnts0Hivaw?e=jch110){target='_blank'}. Once the file has been unzipped, launch the tool by double-clicking the `MultiOAligmentUI.bat` file. The executable will launch an interactive graphical user interface (GUI) as shown in @fig-gui.
