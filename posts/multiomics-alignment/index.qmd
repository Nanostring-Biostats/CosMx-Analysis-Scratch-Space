...
Download and unzip the `MultiO_Alignment_Tool_V1.4.zip` file available [here](https://bruker-my.sharepoint.com/:u:/p/s_korukonda/IQABvwiqkivWR6QEtgeB54RTARczP8QWZ0S_O7xGuP5pk-0?e=cyUX83){target='_blank'}. Once the file has been unzipped, launch the tool by double-clicking the `MultiOAligmentUI.bat` file. The executable will launch an interactive graphical user interface (GUI) as shown in @fig-gui.
