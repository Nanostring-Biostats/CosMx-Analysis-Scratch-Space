...
Download and unzip the “MultiO_Alignment_Tool_SEP2025.zip” file available [here](https://bruker-my.sharepoint.com/:u:/p/s_korukonda/EX2d6Itfh09Kp0OvqmIcOAcB_hgorv0IuxBA7siL0AFz_Q?e=5wI6bI){target='_blank'}. Once the file has been unzipped, launch the tool by double-clicking the “MultiOAligmentUI.bat” file. The executable will launch an interactive graphical user interface (GUI) as shown in @fig-gui.
...
**Important Reminder**: Once the raw protein and RNA data are exported from AtoMx and modified through alignment, the updated data cannot be re-imported into AtoMx. As of AtoMx v2.2 and earlier, the platform retains only the original, pre-aligned data.
