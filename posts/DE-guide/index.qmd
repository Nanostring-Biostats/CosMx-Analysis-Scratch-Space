...
Below is an example snippet of a heatmap of DE results on patches from a larger study:

```{r echo = FALSE, eval = TRUE, out.width = "170%"}
knitr::include_graphics("figures/deheatmap.png")
```

A note on multiplicity: when we run DE across dozens of patches, the problem of multiple testing gets even worse. 
