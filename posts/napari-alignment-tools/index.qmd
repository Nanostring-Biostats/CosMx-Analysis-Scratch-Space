...
#| fig-cap: "After loading a pre-stitched cosmx dataset in `napari`, one could add the custm widgets (B, to the right dock) either (A) via **Plugins** menu or by (C) running short python command in `napari` console."
...
2. **Save**: There are a few options to save the alignment results:
...
#| eval: true
#| echo: false
#| label: "Fig5_save_transform"
#| fig-cap: "Screenshot of the dropdown menu showing how to save image transformations."
#| out.width: "100%"
knitr::include_graphics("./figures/Fig_saveTransform.png")
```
