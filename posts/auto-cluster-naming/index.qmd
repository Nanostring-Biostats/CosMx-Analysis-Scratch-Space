...
- Consider rolling up an annotation if no sibling cluster exists. For example, if you see a `CD8 T cell` cluster but no separate `CD4 T cell` cluster, it may be safer to call it `T cell`. 
