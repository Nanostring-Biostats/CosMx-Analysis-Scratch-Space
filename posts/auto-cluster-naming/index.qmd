...
For cluster $c$ and marker program/node $n$, `HierAnnot` computes an raw enrichment score:
...
- _Low Resolution Clustering_: Try increasing the resolution of your clustering algorithm to create smaller, more distinct clusters.
...
- _Shallower Hierarchies_: If too little specific marker separation remains, remove or simplify fragile branches so the hierarchy stays broad enough for the panel.
