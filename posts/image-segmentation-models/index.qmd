...
To complement these internal datasets and further expand morphological and technical diversity, we incorporated a variety of publicly available datasets that were vetted for commercial usage under permissive licenses (e.g., CC0, CC BY). A complete list of public datasets is provided in the [Appendix](#appendix-public-datasets). These external datasets span:
...
* In nuclear segmentation (Panel A), `NucModel#2` (balanced) outperformed both the pretrained model (`nuclei`, `CP`, `Cyto2` and `Cyto3`) and `NucModel#1` (large, unbalanced set).
...
More details can be found in the [CosMx SMI Data Analysis User Manual (AtoMx v2.0)](https://university.nanostring.com/cosmx-smi-data-analysis-user-manual){target="_blank"}, available through [NanoString University](https://university.nanostring.com/){target="_blank"}.
...
For transparency and clarity, the public datasets included in model training were:

- Deepflash2 neurons [@matthias_griebel_2023_7653312]
- Neural nuclei segmentation (S-BSST265) [@SabineTaschner-Mandl2020]
- AMSActa Fluorescent Neuronal Cells (v1 and v2) [@amsacta6706; @amsacta7347]
...
All datasets were reviewed for license compatibility and are permitted for commercial use under permissive terms (e.g., CC0, CC BY).
