...
(@fig-cell-types). We can also color cells by their niche ('spatialClusteringAssignments'; @fig-niches). 
...
that can help reproduce the figures above and the ones below.
