...
In order for `napari-cosmx` to stitch this dataset, we'll need to rearrange the folders so that the nested raw data are at the top level.
...
for an earlier blog post to create the mouse brain napari files. 
