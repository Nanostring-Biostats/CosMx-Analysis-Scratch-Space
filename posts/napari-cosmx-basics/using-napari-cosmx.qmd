...
layers visible (@fig-initial). These include `FOV labels` and `Segmentation`. Clicking the eye
...
(or proteins). Simply select the target and the color and click `Add layer`. 
