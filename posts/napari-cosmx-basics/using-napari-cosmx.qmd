...
The tips and tricks contained within are not an exhaustive list of features and methods.
:::
...
hard drive. Adjust the file structure to match the standard AtoMx 1.3.2 format. 
Specifically, in your Finder window, create a folder named `mouse_brain`, move:
