...
- [Parse and format data export by AtoMx](_code/vignette/0.-loading-flat-files.html)
- [Custom arranging of tissues and FOVs in space](_code/vignette/1.-finessing-tissues-spatial-arrangement.html)
- [QC and normalization](_code/vignette/2.-QC-and-normalization.html)
- [Dimension reduction (PCA and UMAP)](_code/vignette/3.-dimension-reduction.html)
- [Cell typing](_code/vignette/4.-cell-typing.html)

Then, we go after biology:

- [Defining cells' spatial context](_code/vignette/5.-define-spatial-context.html)
