...
- [Parse and format data export by AtoMx](posts/vignette-basic-analysis/assets/0.-loading-flat-files.html)
- [Custom arranging of tissues and FOVs in space](posts/vignette-basic-analysis/assets/1.-finessing-tissues-spatial-arrangement.html)
- [QC and normalization](posts/vignette-basic-analysis/assets/2.-QC-and-normalization.html)
- [Dimension reduction (PCA and UMAP)](posts/vignette-basic-analysis/assets/3.-dimension-reduction.html)
- [Cell typing](posts/vignette-basic-analysis/assets/4.-cell-typing.html)

Then, we go after biology:

- [Defining cells' spatial context](posts/vignette-basic-analysis/assets/5.-define-spatial-context.html)
