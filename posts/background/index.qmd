...
Note: For details of the origins of background counts, see [Appendix 1.](#appendix1)

Note: This document focuses on background. But always worth bearing in mind is that segmentation errors have a far more deleterious impact on data quality. See [Appendix 2](#appendix2) for a brief discussion.
...
From Figure 1, we see that datasets with more signal tend to also have more background, but that background does not rise as quickly as signal. For a nuanced discussion of how background behaves within a dataset, see [Appendix 3.](#appendix2)
