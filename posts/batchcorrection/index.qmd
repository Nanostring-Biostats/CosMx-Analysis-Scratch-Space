...
This post discusses the topic 'batch effect correction'; what it is, how to detect it, and what downstream methods are potentially impacted. We recommend Harmony [@harmony] as a useful method for correcting batch effects in dimension reduction embeddings such as PCA, and demonstrate an example of how to use the software package.
