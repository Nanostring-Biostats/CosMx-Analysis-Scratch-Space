...
depends on the particular package versions and the version of python. 
I recommend using a version and virtual environment management like [pyenv](https://github.com/pyenv/pyenv) but python's built in
...
- `stitch-images`, which builds the zarr structuere
- `read-targets`, which creates the targets.hdf5 file

Assuming these are in your path, you can
see their help documentation by running `stitch-image --help` or
`read-targets --help`.
...
As mentioned in the [second napari series post](../napari-cosmx-intro/index.qmd), 
...
viewing
metadata](../napari-cosmx-index/index.qmd#sec-adding-metadata)
