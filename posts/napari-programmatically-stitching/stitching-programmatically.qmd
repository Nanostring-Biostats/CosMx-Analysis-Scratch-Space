...
In our [previous post in our napari series](../using-napari-for-cosmx-data/index.qmd){target="_blank"}, we introduced our
...
without the need to use the GUI. The current post is for you.
