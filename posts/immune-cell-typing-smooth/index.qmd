...
This argument should be set to FALSE if your markers list has extensive genes expected to be enriched in multiple cell types; e.g. if many genes like CD3E appeared in marker lists for both CD4 T-cells and CD8 T-cells. 
