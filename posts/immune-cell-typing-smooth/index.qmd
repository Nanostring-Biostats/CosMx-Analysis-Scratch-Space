...
Code for the method and utility functions used in this post can be found in the R package [HieraType](https://github.com/Nanostring-Biostats/CosMx-Analysis-Scratch-Space/tree/Main/_code/HieraType). 
...
However, marker genes remain a strong organizing principle for differentiating cell types.  The cell typing method we describe here captures information from both (a) similar cells and (b) biologically relevant genes, to construct imputed marker gene scores which can be used for probabilistic cell type assignment.
The method is designed to make it easy to enforce prior biological assumptions about the marker genes and expression profiles we expect to see in our cell types, 
