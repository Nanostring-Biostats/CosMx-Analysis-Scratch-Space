...
This post demonstrates a method for calculating the smoothed expected expression of any gene, conditioning on its most similar neighbor cells.  Neighbor cells here are defined based on local proximity in UMAP space. 
...
#' 
#' @return smoother "smoothing" matrix. expression (genes x cells ) x  smoother(cells x cells) , 
...
umap_nn <- function(sem, umapreduc, n_neighbors=100){
  ...
  ## identify nearest n_neighbors (+1 includes the cell itself)
