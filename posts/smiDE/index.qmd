...
We provide general methodology recommendations for how a researcher should apply DE in their own study to avoid potential pitfalls that can damage the integrity of an analysis. Tools for methods discussed in the paper are implemented in the R package [smiDE](https://github.com/Nanostring-Biostats/smiDE){target="_blank"}, with vignettes and examples on the package's github page.

A brief summary of highlights and takeaways from the paper are described throughout the rest of this post.

## Opportunities

While DE analysis has long been a core component of gene expression studies, spatially resolved transcriptomic (SRT) data presents new opportunities for addressing fundamental questions regarding how cells respond to their local environment and interact with other cell types.
