...
This other tool will appear on the CosMx Analysis Scratch Space in June 2024.
...
Functions for FOV QC can be found [here](https://github.com/Nanostring-Biostats/CosMx-Analysis-Scratch-Space/tree/Main/_code/FOV%20QC){target="_blank"}.
The gene-to-barcode mappings needed by this approach are 
[here](https://github.com/Nanostring-Biostats/CosMx-Analysis-Scratch-Space/tree/Main/_code/FOV%20QC/barcodes_by_panel.RDS){target="_blank"}.
