...
categories: [GeoMx, how-tos, segmentation, image processing]
...
To use the pipeline, run `python GeoMx_tangle_mask_pipeline.py` and specify parameters as desired. 
...
#| eval: false
python GeoMx_tangle_mask_pipeline.py --in_dir imageFolder --cyto_chan 4 --query_chan 3 --out_dir outputFolder --min_positive_area 500
```
...
#| eval: false
usage: GeoMx_tangle_mask_pipeline.py [-h] [--in_dir IN_DIR] [--out_dir OUT_DIR] [--cyto_chan CYTO_CHAN]
